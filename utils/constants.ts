...
export const DEFAULT_APPS = ['explorer', 'terminal', 'wirebox', 'coder', 'games', 'calco', 'weather', 'settings', 'market', 'helper', 'wepic', 'weplayer', 'notiftester'];
