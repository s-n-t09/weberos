<div align="center">
  ...
  <h1 align="center">WeberOS v2.1</h1>
...
## 🛡️ API Permissions (v2.1)

In version 2.1, you can request system permissions in your `.wbr` manifest to access advanced features.
